...
#SIMULATE WITH CAMERA
	...
	$(sleep 5 ; mv $AEROSTACK_WORKSPACE/develIgnore $AEROSTACK_WORKSPACE/devel) & roslaunch configs/gazebo_files/launch/multi_uav_mavros_sitl_sdf.launch world:=${APPLICATION_PATH}/configs/gazebo_files/worlds/emptyfarm.world vehicle:=iris sdf:=${APPLICATION_PATH}/configs/gazebo_files/models/iris_cam/iris_cam.sdf respawn_gazebo:=true
