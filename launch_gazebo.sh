...
#SIMULATE WITH CAMERA
	...
	roslaunch configs/gazebo_files/launch/multi_uav_mavros_sitl_sdf.launch world:=${AEROSTACK_PROJECT}/configs/gazebo/worlds/suspension_bridge.world vehicle:=iris sdf:=${AEROSTACK_PROJECT}/configs/gazebo/models/iris_cam/iris_cam.sdf respawn_gazebo:=true
